 ...
 *
 * Point de wrap **unique** du projet : le lissage de cap ([com.hexa.location.HeadingSmoother]) et la
 * source boussole partagent cette définition plutôt que d'en recopier la formule. `public` à dessein
